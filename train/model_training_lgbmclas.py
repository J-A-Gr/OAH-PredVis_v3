...
plt.title('LightGBM ROC (2025+ Products)')
plt.legend()
plt.tight_layout()
plt.show()
...
plt.title('LightGBM Precision–Recall (2025+ Products)')
plt.legend()
plt.tight_layout()
plt.show()

# ─── 10. Save model ───────────────────────────────────────────────────────────
joblib.dump(lgb, 'models/lgbm_product_time_split.pkl')
