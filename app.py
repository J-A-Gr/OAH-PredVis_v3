...
# Open a persistent SQLite connection and load the entire products table
conn = sqlite3.connect('data/final/products.db', check_same_thread=False)
products = pd.read_sql('SELECT * FROM products_imputed', conn)
